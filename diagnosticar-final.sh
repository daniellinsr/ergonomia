...
# Script final para diagnosticar empresa_id usando o container principal

echo "=== Diagnóstico: Empresa ID das Avaliações ==="
echo ""

# Usar o container principal do PostgreSQL
...
docker exec -i $CONTAINER_ID psql -U postgres -d ergonomia_db << 'EOF'
